      ...
      <div className="my-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <dl className="mt-16 grid grid divide-x divide-y divide-gray-700 overflow-hidden rounded-2xl border text-center text-gray-600 border-gray-700 sm:grid-cols-1 lg:grid-cols-3  lg:divide-y-0 xl:grid-cols-3">
              <Step
